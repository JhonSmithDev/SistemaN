	...
	*/
	class usuario extends model{
		...
		public function showTable($table){
			...
			$result = $this->_db->query("SELECT * FROM grupousu WHERE  show_by= '1'");
			$retorna = $result->fetch_all(MYSQL_ASSOC);
			...
			foreach ($retorna as $clave => $valor) {
			    ...
			    $outp_select[] = array('id'=> $valor['idGrupoUsu'],
									   'value'=> $valor['nom_gu']
										);
			...
			*/
			...
			$outp[] = array('name'=> "login_usu",
							'label'=> "LOGIN USUARIO",
							'tipo'=> "text",
							'class'=> "",
							'value'=> "");

			$outp[] = array('name'=> "pass_usu",
							'label'=> "CONTRASEÑA",
							'tipo'=> "text",
							'class'=> "",
							'value'=> "");

			$outp[] = array('name'=> "apellidos_usu",
							'label'=> "APELLIDOS",
							'tipo'=> "text",
							'class'=> "",
							'value'=> "");

			$outp[] = array('name'=> "nombres_usu",
							'label'=> "NOMBRES",
							'tipo'=> "text",
							'class'=> "",
							'value'=> "");

			$outp[] = array('name'=> "telef_usu",
							'label'=> "TELÉFONO",
							'tipo'=> "text",
							'class'=> "",
							'value'=> "");

			$outp[] = array('name'=> "dir_usu",
							'label'=> "DIRECCIÓN",
							'tipo'=> "text",
							'class'=> "",
							'value'=> "");

			$outp[] = array('name'=> "correo_usu",
							'label'=> "CORREO ELECTRÓNICO",
							'tipo'=> "text",
							'class'=> "",
							'value'=> "");

			$outp[] = array('name'=> "cargo_usu",
							'label'=> "CARGO",
							'tipo'=> "text",
							'class'=> "",
							'value'=> "");
			...
			// Creacion de campos
			$outp[] = array('name'=> "GrupoUsu_idGrupoUsu",
							'label'=> "GRUPO USUARIO",
							'tipo'=> "select",
							'class'=> "",
		...
		public function showTableAllModify($table, $nom_idTable, $id){
			...
			//tabla select all
			$result_select = $this->_db->query("SELECT * FROM grupousu WHERE show_by = '1'");
			...
			$result_selectId = $this->_db->query("SELECT * FROM grupousu WHERE show_by = '1' and idGrupoUsu = '".$retorna_main[0]['GrupoUsu_idGrupoUsu']."'");
			...
			foreach ($retorna_selectId as $clave => $valor) {
    			//print_r($valor['categoria_producto']);
			    $outp_selectId = array('id'=> $valor['idGrupoUsu'],
									   'value'=> $valor['nom_gu']
									   );
			...
			$result_selectId->close();
			*/
			$outp[] = array('name'=> "idUsuario",
							'label'=> "ID USUARIO",
							'tipo'=> "text-block",
							'class'=> "",
							'valueSelect'=> "",
							'value'=> "".$retorna_main[0]['idUsuario']."");
			...
			$outp[] = array('name'=> "ci_usu",
							...
							'class'=> "",
							'valueSelect'=> "",
							'value'=> "".$retorna_main[0]['ci_usu']."");

			$outp[] = array('name'=> "login_usu",
							'label'=> "LOGIN USUARIO",
							'tipo'=> "text",
							'class'=> "",
							'value'=> "".$retorna_main[0]['login_usu']."");

			$outp[] = array('name'=> "pass_usu",
							'label'=> "CONTRASEÑA",
							'tipo'=> "text",
							'class'=> "",
							'value'=> "".$retorna_main[0]['pass_usu']."");

			$outp[] = array('name'=> "apellidos_usu",
							'label'=> "APELLIDOS",
							'tipo'=> "text",
							'class'=> "",
							'value'=> "".$retorna_main[0]['apellidos_usu']."");

			$outp[] = array('name'=> "nombres_usu",
							'label'=> "NOMBRES",
							'tipo'=> "text",
							'class'=> "",
							'value'=> "".$retorna_main[0]['nombres_usu']."");

			$outp[] = array('name'=> "telef_usu",
							'label'=> "TELÉFONO",
							'tipo'=> "text",
							'class'=> "",
							'value'=> "".$retorna_main[0]['telef_usu']."");

			$outp[] = array('name'=> "dir_usu",
							'label'=> "DIRECCIÓN",
							'tipo'=> "text",
							'class'=> "",
							'value'=> "".$retorna_main[0]['dir_usu']."");

			$outp[] = array('name'=> "correo_usu",
							'label'=> "CORREO ELECTRÓNICO",
							'tipo'=> "text",
							'class'=> "",
							'value'=> "".$retorna_main[0]['correo_usu']."");

			$outp[] = array('name'=> "cargo_usu",
							'label'=> "CARGO",
							'tipo'=> "text",
							'class'=> "",
							'value'=> "".$retorna_main[0]['cargo_usu']."");
