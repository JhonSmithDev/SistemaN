<?php
	...
	*/
	class moneda extends model{
		...
		public function showTable($table){
			...
			*/
			...
			$outp[] = array('name'=> "obs_moneda",
							'label'=> "OBSERVACIÓN MONEDA",
							'tipo'=> "text",
							'class'=> "",
							'value'=> "");
		...
		public function showTableAllModify($table, $nom_idTable, $id){
			...
			*/
			$outp[] = array('name'=> "tipo_moneda",
							...
							'class'=> "",
							'valueSelect'=> "",
							'value'=> "".$retorna_main[0]['tipo_moneda']."");

			$outp[] = array('name'=> "obs_moneda",
							'label'=> "OBSERVACIÓN MONEDA",
							'tipo'=> "text",
							'class'=> "",
							'value'=> "".$retorna_main[0]['obs_moneda']."");
	...
	//objeto a manipular
	$object = new moneda();
	$table = "moneda"; //nombre de la tabla
	$nom_idTable = "idMoneda";
