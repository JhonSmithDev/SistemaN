<?php
	...
	*/
	class proveedor extends model{
		...
		public function showTable($table){
			...
			*/
			...
			$outp[] = array('name'=> "nom_prov",
							'label'=> "NOMBRE PROVEEDOR",
							'tipo'=> "text",
							'class'=> "",
							'value'=> "");

			$outp[] = array('name'=> "dir_prov",
							'label'=> "DIRECCIÓN PROVEEDOR",
							'tipo'=> "text",
							'class'=> "",
							'value'=> "");

			$outp[] = array('name'=> "telef_prov",
							'label'=> "TELÉFONO DEL PROVEEDOR",
							'tipo'=> "text",
							'class'=> "",
							'value'=> "");

			$outp[] = array('name'=> "fax_prov",
							'label'=> "FAX DEL PROVEEDOR",
							'tipo'=> "text",
							'class'=> "",
							'value'=> "");

			$outp[] = array('name'=> "cel_prov",
							'label'=> "CELULAR DEL PROVEEDOR",
							'tipo'=> "text",
							'class'=> "",
							'value'=> "");

			$outp[] = array('name'=> "email_prov",
							'label'=> "CORREO ELECTRÓNICO",
							'tipo'=> "text",
							'class'=> "",
							'value'=> "");

			$outp[] = array('name'=> "pais_prov",
							'label'=> "PAÍS DEL PROVEEDOR",
							'tipo'=> "text",
							'class'=> "",
							'value'=> "");

			$outp[] = array('name'=> "ciudad_prov",
		...
		public function showTableAllModify($table, $nom_idTable, $id){
			...
			$result_selectId->close();
			*/
			$outp[] = array('name'=> "idProveedor",
							'label'=> "ID PROVEEDOR",
							'tipo'=> "text-block",
							'class'=> "",
							'valueSelect'=> "",
							'value'=> "".$retorna_main[0]['idProveedor']."");
			...
			$outp[] = array('name'=> "cod_prov",
							...
							'class'=> "",
							'valueSelect'=> "",
							'value'=> "".$retorna_main[0]['cod_prov']."");

			$outp[] = array('name'=> "nom_prov",
							'label'=> "NOMBRE PROVEEDOR",
							'tipo'=> "text",
							'class'=> "",
							'value'=> "".$retorna_main[0]['nom_prov']."");

			$outp[] = array('name'=> "dir_prov",
							'label'=> "DIRECCIÓN PROVEEDOR",
							'tipo'=> "text",
							'class'=> "",
							'value'=> "".$retorna_main[0]['dir_prov']."");

			$outp[] = array('name'=> "telef_prov",
							'label'=> "TELÉFONO DEL PROVEEDOR",
							'tipo'=> "text",
							'class'=> "",
							'value'=> "".$retorna_main[0]['telef_prov']."");

			$outp[] = array('name'=> "fax_prov",
							'label'=> "FAX DEL PROVEEDOR",
							'tipo'=> "text",
							'class'=> "",
							'value'=> "".$retorna_main[0]['fax_prov']."");

			$outp[] = array('name'=> "cel_prov",
							'label'=> "CELULAR DEL PROVEEDOR",
							'tipo'=> "text",
							'class'=> "",
							'value'=> "".$retorna_main[0]['cel_prov']."");

			$outp[] = array('name'=> "email_prov",
							'label'=> "CORREO ELECTRÓNICO",
							'tipo'=> "text",
							'class'=> "",
							'value'=> "".$retorna_main[0]['email_prov']."");

			$outp[] = array('name'=> "pais_prov",
							'label'=> "PAÍS DEL PROVEEDOR",
							'tipo'=> "text",
							'class'=> "",
							'value'=> "".$retorna_main[0]['pais_prov']."");

			$outp[] = array('name'=> "ciudad_prov",
							'label'=> "CIUDAD DEL PROVEEDOR",
							'tipo'=> "text",
							'class'=> "",
							'value'=> "".$retorna_main[0]['ciudad_prov']."");
	...
	//objeto a manipular
	$object = new proveedor();
	$table = "proveedor"; //nombre de la tabla
	$nom_idTable = "idProveedor";
